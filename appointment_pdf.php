...
{
    // Logo
    $this->Image('image/logo.png',10,6,50);
    // Arial bold 15
    $this->SetFont('Arial','B',15);
    // Move to the right
    $this->Cell(80);
    // Title
    $this->Cell(40,10,'RSUD SLEMAN',1,0,'C');
    // Line break
    $this->Ln(40);
...
$pdf->Ln(10);
$pdf->Write(5,'         Nama Pasien            :'.$patient_name.'');
$pdf->Ln(10);
$pdf->Write(5,'         Umur                      :'.$patient_age.'');
$pdf->Ln(10);
$pdf->Write(5,'         Jenis Kelamin                  :'.$gender.'');
$pdf->Ln(10);
$pdf->Write(5,'         ID Rumah Sakit             :'.$hos_id.'');
$pdf->Ln(10);
$pdf->Write(5,'         ID Dokter               :'.$doc_id.'');
$pdf->Ln(10);
$pdf->Write(5,'         Nama Dokter             :'.$doc_name.'');
$pdf->Ln(10);
$pdf->Write(5,'         Hari                    :'.$date.'');
$pdf->Ln(10);
$pdf->Write(5,'         Jam               :'.$time_slot.'');
$pdf->Ln(10);   


$pdf->Write(5,'Tanda tangan pasien    :');
$pdf->Ln(10);


$pdf->Write(5,'Tanda tangan dokter     :');
