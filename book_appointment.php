...
<?php /*--------Validate and Insert-----------------------*/
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") 
	{
		...
		{
			$nameErr = "*Nama pasien dibutuhkan";
		} 
		else 
		{
		...
		else 
		{
			...
			if (!is_numeric($age)) 
			{
				$ageErr = "*Masukkan umur yang valid"; 
			}
		}
		//////////////////////////////////////////////////////////	   
...
<body>
	...
	<center>
		<div class="form-box">
			<center>
				<div class="register" style="font-size:32;">Detail Pendaftaran</div>
				<div class="form_box">
					<form class="form-horizontal" role="form" action="" method="post">
						...
						<div class="form-group">
							<label class="control-label col-sm-4">Rumah Sakit</label>
							<div class="col-sm-8"> 
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="patient_name" value="<?php echo $name;?>"  placeholder="Masukkan nama pasien">
								<span><?php echo $nameErr; ?></span>
							</div>
						</div>
						
						<div class="form-group">
							<label class="control-label col-sm-4">Umur</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="patient_age" value="<?php echo $age;?>" placeholder="Masukkan umur pasien">
						...
						<div class="form-group">
							...
							<div class="col-sm-8"> 
								<select name="gender" class="form-control" >
									<?php if(empty($gender)){?>
									<option value="">Pilih Jenis Kelamin</option> <?php } else { ?>
						...
						<div class="form-group">
							<label for="sel1" class="control-label col-sm-4">Pilih Jam</label>
							<div class="col-sm-8">
